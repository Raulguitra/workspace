...
Esto lo realizara un método al que le pasaremos el 
 * numero como parámetro, devolverá un String con el numero convertido a binario. 
 * Para convertir un numero decimal a binario, 
 * debemos dividir entre 2 el numero y el resultado de esa división se divide entre 2 de 
 * nuevo hasta que no se pueda dividir mas,
